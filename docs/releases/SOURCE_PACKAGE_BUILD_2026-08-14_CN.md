...
docker build \
  ...
  --build-arg UPDATE_REPO=Jimmyweng0514/sub2api \
  --build-arg REPOSITORY_URL=https://github.com/Jimmyweng0514/sub2api \
  -t ghcr.io/Jimmyweng0514/sub2api:0.2.0 .
```
...
go build -tags embed -trimpath \
  -ldflags="-s -w -X main.Version=0.2.0 -X main.BuildType=release -X main.UpdateRepo=Jimmyweng0514/sub2api" \
