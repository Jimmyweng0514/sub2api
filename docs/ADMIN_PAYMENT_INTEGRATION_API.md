...
> Sub2API Plus 单文件中英双语文档 / Single-file bilingual documentation (Chinese + English)
...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/Jimmyweng0514/sub2api/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/Jimmyweng0514/sub2api/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
...
- View URL: `https://github.com/Jimmyweng0514/sub2api/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/Jimmyweng0514/sub2api/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
