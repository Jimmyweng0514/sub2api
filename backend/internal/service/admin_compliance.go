...
const (
	AdminComplianceVersion        = "v2026.08.15"
	...
	AdminComplianceDocumentURLZH  = "https://github.com/Jimmyweng0514/sub2api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/Jimmyweng0514/sub2api/blob/main/docs/legal/admin-compliance.en.md"
