...
# Sub2API Plus 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Jimmyweng0514/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="${SUB2API_UPDATE_REPO:-Jimmyweng0514/sub2api}"
...
download_and_extract() {
    ...
    local archive_name="sub2api-plus_${version_num}_${OS}_${ARCH}.tar.gz"
