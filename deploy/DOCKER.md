...
```text
ghcr.io/Jimmyweng0514/sub2api:latest
```
...
```text
ghcr.io/Jimmyweng0514/sub2api:dev
```
...
```dotenv
SUB2API_IMAGE=ghcr.io/Jimmyweng0514/sub2api:0.2.0
SUB2API_UPDATE_REPO=Jimmyweng0514/sub2api
```
